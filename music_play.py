...
frame_esquerda = Frame(janela, width=120, height=140, bg=co3)
...
frame_baixo = Frame(janela, width=404, height=150, bg=co3)
...
img_1 = img_1.resize((145, 140))
img_1 = ImageTk.PhotoImage(img_1)

l_logo = Label(frame_esquerda, height=200, image=img_1, compound=LEFT, padx=0, anchor='nw', font=('ivy 16 bold'), bg=co3, fg=co3)
l_logo.place(x=1, y=0)
...
listbox = Listbox(frame_direita, width=31, height=9, selectmode=SINGLE, font=('aria 8 bold'), bg=co3, fg=co1)
listbox.grid(row=0, column=0)

s = Scrollbar(frame_direita)
s.grid(row=0, column=5, sticky=NSEW)
...
b_voltar = Button(frame_baixo, command=anterior_musica, width=40, height=40, image=img_2, font=('ivy 10 bold'), relief=RAISED, overrelief=RIDGE, bg=co5, fg=co1)
b_voltar.place(x=38, y=35)

img_3 = Image.open('play.png')
img_3 = img_3.resize((30, 30))
img_3 = ImageTk.PhotoImage(img_3)
b_play = Button(frame_baixo, command=play_musica, width=40, height=40, image=img_3, font=('ivy 10 bold'), relief=RAISED, overrelief=RIDGE, bg=co5, fg=co1)
b_play.place(x=84, y=35)

img_4 = Image.open('passar.png')
img_4 = img_4.resize((30, 30))
img_4 = ImageTk.PhotoImage(img_4)
b_passar = Button(frame_baixo, command=proxima_musica, width=40, height=40, image=img_4, font=('ivy 10 bold'), relief=RAISED, overrelief=RIDGE, bg=co5, fg=co1)
b_passar.place(x=130, y=35)

img_5 = Image.open('pause.png')
img_5 = img_5.resize((30, 30))
img_5 = ImageTk.PhotoImage(img_5)
b_pause = Button(frame_baixo, command=pausar_musica, width=40, height=40, image=img_5, font=('ivy 10 bold'), relief=RAISED, overrelief=RIDGE, bg=co5, fg=co1)
b_pause.place(x=176, y=35)

img_6 = Image.open('continuar(1).png')
img_6 = img_6.resize((30, 30))
img_6 = ImageTk.PhotoImage(img_6)
b_continuar = Button(frame_baixo, command=continuar_musica, width=40, height=40, image=img_6, font=('ivy 10 bold'), relief=RAISED, overrelief=RIDGE, bg=co5, fg=co1)
b_continuar.place(x=222, y=35)

img_7 = Image.open('stop-button.png')
img_7 = img_7.resize((30, 30))
img_7 = ImageTk.PhotoImage(img_7)
b_stop = Button(frame_baixo, command=parar_musica, width=40, height=40, image=img_7, font=('ivy 10 bold'), relief=RAISED, overrelief=RIDGE, bg=co5, fg=co1)
